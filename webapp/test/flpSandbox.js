		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Supplier Load App",
									"targetURL": "#comyazakiyazakisupload-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comyazakiyazakisupload-display": {
								"semanticObject": "comyazakiyazakisupload",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.yazaki.yazakisupload",
									"url": sap.ui.require.toUrl("com/yazaki/yazakisupload")
								}
							}
						}
					}
